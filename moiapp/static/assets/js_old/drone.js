$(document).ready(function(){
  ...
  drone_traffic();
    ...
    function saveDroneData() {
      ...
      }else if(status  === "Light" || status === "غير مزدحم"){
        ...
        success: function(response) {
            ...
            if(response.status  === "Heavy"){
              ...
              if (dir === "ltr") {
                ...
                $("#drone_traffic_status_values").text("غير مزدحم");
              }
...
//             // Update these to match the field names from your Django view
//             $("#drone_traffic_value").text(response.value.Number_of_total_vehicles);
//             $("#drone_traffic_status_values").text(response.value.final_result);
//             $("#drone_latest_Time").text(response.value.time);

//             if(response.value.final_result  === "Heavy"){
//               if (dir === "ltr") {
//                 $("#drone_traffic_status_values").text(response.value.final_result);
//               }if(dir === "rtl"){
//                 $("#drone_traffic_status_values").text("مزدحم");
//               }
             

//             }else if(response.final_result  === "Moderate"){

//               if (dir === "ltr") {
//                 $("#drone_traffic_status_values").text(response.final_result);
//               }if(dir === "rtl"){
//                 $("#drone_traffic_status_values").text("معتدل");
//               }

//             }else if(response.value.final_result  === "Light"){
