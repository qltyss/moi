$(document).ready(function(){
    ...
    var video = document.getElementById('videoElement');
       ...
       $("#saveFace").click(function() {
                ...
                .then(data => {
                    ...
                    console.log('image to save:', img2Base64);
                    $(this).find('i').show();
                    $("#submitText").text('Submit');                   
                    $('#spinner').addClass('d-none');
                    
                    $('#error_div').removeClass('text-danger');
                    $('#error_div').addClass('text-success');
                    $("#error_div").text("Processing...");
                    saveEmp(name, img2Base64);
                    $('#spinner').addClass('d-none');
                    $('#spinner').addClass('d-none');
                ...
                .catch(error => {
                    ...
                    $('#error_div').removeClass('text-success');
                    $('#error_div').addClass('text-danger');
                    $("#error_div").text("Error To Add Employee..Please Try Again");
                    $("#loaderrow").addClass("d-none")
                });
    ...
    function saveEmp(name, img2Base64){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#error_div').removeClass('text-danger');
                $('#error_div').addClass('text-success');
                $("#error_div").text("Employee Add Successfully");
            },
